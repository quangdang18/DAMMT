...
try:
    ...
    # Lệnh nén
    tar_command = 'tar -czvf output1.tar.gz --directory=/home/tkien/Downloads/opt/gama-platform/headless output'

    # Thực thi lệnh nén
    stdin, stdout, stderr = client.exec_command(tar_command)

    # Đường dẫn tới tệp cần gửi từ máy A
    localpath = "output1.tar.gz"

    # Đường dẫn đến thư mục trên máy B để lưu tệp
    remotepath = "/home/tkien/output1.tar.gz"
